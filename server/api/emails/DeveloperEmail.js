  ...
  * {
  ...
  <!--<![endif]-->
      <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
        ...
        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
          <p style="Margin-top: 0;Margin-bottom: 0;text-align: center;">Hello ${name},<br />
  Grace has sent you a payment of ${balance} ETH for the fulfillment of contract ${contractHash}.<br />
  Thank you for using Grace!<br />
 
  </p><p style="Margin-top: 20px;Margin-bottom: 20px;text-align: center;">&nbsp;</p>
        </div>
      </div>
              
                <div style="Margin-left: 20px;Margin-right: 20px;">
        <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
          <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #86c7bf;font-family: Avenir, sans-serif;" href="http://localhost:8080/payment/${contractHash}">View campaign</a><![endif]>
