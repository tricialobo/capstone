const DeveloperEmail = (name, contractHash, balance) => {
    ...
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      <div role="banner">
        ...
        <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 600px"><![endif]-->
          ...
          <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 211px;" src="images/logo.png" alt="" width="211" /></div>
          <p class="size-64" style="Margin-top: 0;Margin-bottom: 0;font-size: 64px;text-align: center;" lang="x-size-64"><span style="color:#000000"><strong>grace</strong></span></p>
      ...
      <div style="background-color: #000000;">
        <div class="layout three-col" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
          ...
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-full-width" style="background-color: #281557;"><td class="layout__edges">&nbsp;</td><td style="width: 200px" valign="top" class="w160"><![endif]-->
            <div class="column" style="Float: left;max-width: 320px;min-width: 200px; width: 320px;width: calc(72200px - 12000%);text-align: left;color: #8e959c;font-size: 14px;font-family: sans-serif;">
      ...
      <div style="mso-line-height-rule: exactly;line-height: 10px;font-size: 1px;">&nbsp;</div>
              ...
              <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;font-size: 1px;">&nbsp;</div>
    </div>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
        <h2 style="Margin-top: 20;Margin-bottom: 0;font-style: normal;font-weight: normal;color: 000000;font-size: 26px;line-height: 34px;font-family: Avenir,sans-serif;text-align: center;"><strong>Hello ${name},</strong></h2><p style="Margin-top: 16px;Margin-bottom: 0;text-align: center;"><strong>Grace has sent&nbsp;a payment of ${balance} ETH to your Etherium wallet&nbsp;for the fulfillment of contract ${contractHash}.</strong></p><p style="Margin-top: 20px;Margin-bottom: 0;text-align: center;"><strong>Thank you for using Grace. We hope to see you soon!</strong></p>
      </div>
    </div>
      ...
      <div style="mso-line-height-rule: exactly;font-size: 50px;">&nbsp;</div>
